 $output = "C:\FMBPublic\Downloads\dm_spl_release_human_rx_part3.zip"
$targetFolder = "C:\FMBPublic\Downloads\Upload\dm_spl_release_human_rx_part3"
[System.Reflection.Assembly]::LoadWithPartialName('System.IO.Compression.FileSystem')
[System.IO.Compression.ZipFile]::ExtractToDirectory($output, $targetFolder)

$ZipFilesPath = "$targetFolder\prescription"
$UnzipPath = "$targetFolder\prescription\"
